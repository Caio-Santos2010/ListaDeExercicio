//Criar um programa para verificar se o número 12 é divisivel por 2 e por 3
let num = 12;
if (num % 2 === 0 && num % 3 === 0) {
...
if (preco >= 800) {
    ...
    console.log(`O preço com desconto é ${desconto}`)
} else {
    console.log('não tem desconto')
}

//Criar um programa que mostre os números de 1 a 10 usando laço repetição
for (let i =1; i <=10; i++) {
    console.log(i)
}
